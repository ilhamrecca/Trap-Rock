...
public class VerticalWhiteBlock extends Tile {
	...
	public VerticalWhiteBlock(Handlers handler, int type, int x, int y) {
		super(handler, type, Assets.woodBlock, x, y, HEIGHT, WIDTH);
		
		rotateWhite = ImageLoader.rotateCw(Assets.whiteBlock);
...
//		this.bounds.width -= this.bounds.x * 2;
	...
	@Override
	public int getType() {
		return Tile.VERTICALWHITEBLOCK;
	}
}
